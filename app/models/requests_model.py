...
class DecedentRequest(Base):
   ...
   person_dealing_with_estate = Column(TINYINT(1), nullable=False, server_default='1')
   ...
   is_verify_identity = Column(String(5), nullable=False, server_default='1')
   ...
   identification_id = Column(String(36), nullable=False, server_default='citizenship')
   id_number = Column(String(30), nullable=False,server_default="555-555-5555")
